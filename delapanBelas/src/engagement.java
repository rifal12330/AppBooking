 ...
 * @author rifal
 */
public class engagement extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_booknow.setText("BOOKING NOW");
        btn_booknow.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_booknowActionPerformed(evt);
            }
        });
        getContentPane().add(btn_booknow, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 570, 160, 40));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/engagement.png"))); // NOI18N
